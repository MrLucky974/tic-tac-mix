namespace LuckiusDev.Utils
{
    ...
    public static class PredefinedAssemblyUtil
    {
        ...
        public static List<Type> GetTypes(Type interfaceType)
        {
            ...
            assemblyTypes.TryGetValue(AssemblyType.ASSEMBLY_C_SHARP, out var assemblyCSharpTypes);
            AddTypesFromAssembly(assemblyCSharpTypes, interfaceType, types);

            assemblyTypes.TryGetValue(AssemblyType.ASSEMBLY_C_SHARP_FIRST_PASS, out var assemblyCSharpFirstPassTypes);
